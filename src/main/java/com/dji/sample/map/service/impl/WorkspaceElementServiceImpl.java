...
public class WorkspaceElementServiceImpl implements IWorkspaceElementService {
    ...
    @Override
    public HttpResultResponse saveElement(String workspaceId, String groupId, CreateMapElementRequest elementCreate) {
    ...
    @Override
    public HttpResultResponse updateElement(String workspaceId, String elementId, UpdateMapElementRequest elementUpdate, String username) {
    ...
    public HttpResultResponse deleteAllElementByGroupId(String workspaceId, String groupId) {
        ...
        for (MapGroupElement groupElement : groupElementList) {
            HttpResultResponse response = this.deleteElement(workspaceId, groupElement.getId());
